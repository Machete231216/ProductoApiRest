...
public class User implements UserDetails {
    ...
    //relaccion bidireccionañ. Usuario es el lado propietario, porque tiene la tabla intermedia
    ...
    @JoinTable( // para crear la tabla intermedia en elN:M
            name = "users_roles", //este es el nombre de la tabla, si existiera la tabla abria que pponerle su noombre
            joinColumns = @JoinColumn(name = "user_id"), //estos son los nombres de las columnas de la tabla intermedia
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return roles.stream()
                // si en bd el Role no tiene el prefijo ROLE_
                //.map (Role -> (GrantedAuthority) () -> "ROLE_"+rol.getName())
